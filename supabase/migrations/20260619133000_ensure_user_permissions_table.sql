...
alter table public.user_permissions
  ...
  add column if not exists can_toggle boolean not null default false,
...
create unique index if not exists user_permissions_employee_module_uidx
on public.user_permissions(employee_id, module_key);
