...
create index if not exists services_internal_code_idx on public.services(internal_code);
create index if not exists service_categories_status_idx on public.service_categories(status);
create index if not exists service_professionals_service_id_idx on public.service_professionals(service_id);
create index if not exists service_professionals_employee_id_idx on public.service_professionals(employee_id);
create index if not exists service_packages_status_idx on public.service_packages(status);
create index if not exists service_discounts_service_id_idx on public.service_discounts(service_id);
create index if not exists service_discounts_package_id_idx on public.service_discounts(package_id);
create index if not exists commercial_rules_status_idx on public.commercial_rules(status);
create index if not exists treatment_protocols_status_idx on public.treatment_protocols(status);
create index if not exists service_resources_service_id_idx on public.service_resources(service_id);
create index if not exists internal_notifications_status_idx on public.internal_notifications(status);
create index if not exists internal_notifications_service_id_idx on public.internal_notifications(service_id);
create index if not exists service_audit_logs_service_id_idx on public.service_audit_logs(service_id);
