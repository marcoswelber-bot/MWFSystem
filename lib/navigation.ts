import { BarChart3, BriefcaseMedical, Building2, CalendarDays, ClipboardList, LayoutDashboard, PackageCheck, Settings, Stethoscope, UsersRound, WalletCards } from "lucide-react";
